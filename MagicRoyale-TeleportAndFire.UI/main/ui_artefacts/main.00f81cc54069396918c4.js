...
/***/ "./src/engine/actionController.ts":
/*!****************************************!*\
  !*** ./src/engine/actionController.ts ***!
  \****************************************/
...
var ActionController = /*#__PURE__*/function () {
   ...
   */
  function ActionController(engine) {
    _classCallCheck(this, ActionController);

    this.engine = engine;
    // TODO [delete]
    this.actionsAtEveryStep.push(this.eventsHandlersInitilization); // создаем класс, который вызывает главный шаг 60 раз в сек
  ...
  */
  ...
  _createClass(ActionController, [{
    ...
    value: function mainStep() {
      // выполнить дополнительный действия каждого цикла
      this.actionsAtEveryStep.forEach(function (element) {
        element();
    ...
    key: "eventsHandlersInitilization",
    value: function eventsHandlersInitilization() {// TODO [NotImpl] - перехват масштабирования\перемещения карты
...
var LoopWorker = /*#__PURE__*/function () {
   ...
   */
  function LoopWorker(oneEngineStep) {
    _classCallCheck(this, LoopWorker);
  ...
  _createClass(LoopWorker, [{
    key: "engineActionsInitialization",
    value: function engineActionsInitialization() {
    ...
    key: "recursionEngineStep",
    value: function recursionEngineStep() {
      if (!this.isEnginePause) {
        // если не на паузе
    ...
    key: "animationFrame",
    value: function animationFrame(oneEngineStep) {
...
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./common */ "./src/engine/common.ts");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Camera = /*#__PURE__*/function () {
  _createClass(Camera, [{
    ...
    set: function set(scaleMap) {
      if (scaleMap < this.minScaleMap) {
        // если передали значение меньше минимального, то запишется минимальное
        this._scaleMap = this.minScaleMap;
      } else if (scaleMap >= this.minScaleMap) {
        // если передали больше минимального, то запишется как есть
  ...
  * @constructor
  */
  function Camera(coordinates, scaleMap) {
    _classCallCheck(this, Camera);

    this.coordinates = new _common__WEBPACK_IMPORTED_MODULE_0__["X_Y"](0, 0);
    this.scaleMap = 1;
  } // - Камера
...
var Canvas = /*#__PURE__*/function () {
   ...
   */
  function Canvas(parrentElement) {
    var canvasIsMainElement = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  ...
  _createClass(Canvas, [{
    ...
    key: "createCanvasHtml",
    value: function createCanvasHtml() {
    ...
    key: "createCanvasCss",
    value: function createCanvasCss() {
    ...
    key: "canvasToFullDocument",
    value: function canvasToFullDocument() {
...
/*!******************************!*\
  !*** ./src/engine/common.ts ***!
  \******************************/
/*! exports provided: X_Y, sleep */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "X_Y", function() { return X_Y; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sleep", function() { return sleep; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var X_Y = function X_Y(x, y) {
  _classCallCheck(this, X_Y);
...
*/
function DebugMode() {
  _classCallCheck(this, DebugMode);
} // - Режим разработчика:
...
/* harmony import */ var _actionController__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./actionController */ "./src/engine/actionController.ts");
/* harmony import */ var _canvas__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./canvas */ "./src/engine/canvas.ts");
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./render */ "./src/engine/render.ts");
/* harmony import */ var _debugMode__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./debugMode */ "./src/engine/debugMode.ts");
/* harmony import */ var _spriteHolder__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./spriteHolder */ "./src/engine/spriteHolder.ts");
/* harmony import */ var _spriteHolder__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_spriteHolder__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _camera__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./camera */ "./src/engine/camera.ts");
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./common */ "./src/engine/common.ts");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Engine = /*#__PURE__*/function () {
  ...
  */
  function Engine(parrentElement) {
    _classCallCheck(this, Engine);

    this._canvas = new _canvas__WEBPACK_IMPORTED_MODULE_1__["Canvas"](parrentElement, true);
    this._spriteHolder = new _spriteHolder__WEBPACK_IMPORTED_MODULE_4__["SpriteHolder"]();
    var camera = new _camera__WEBPACK_IMPORTED_MODULE_5__["Camera"](new _common__WEBPACK_IMPORTED_MODULE_6__["X_Y"](0, 0), 1);
    this._render = new _render__WEBPACK_IMPORTED_MODULE_2__["Render"](this._canvas.canvasElement, camera);
    this._debugMode = new _debugMode__WEBPACK_IMPORTED_MODULE_3__["DebugMode"]();
    this._actionController = new _actionController__WEBPACK_IMPORTED_MODULE_0__["ActionController"](this);
  }
...
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./common */ "./src/engine/common.ts");
...
var Render = /*#__PURE__*/function () {
  _createClass(Render, [{
    ...
    set: function set(canvasElement) {
  ...
  function Render(canvasElement, camera) {
  ...
  */
  ...
  _createClass(Render, [{
    key: "renderSprites",
    value: function renderSprites(sprites) {
      this.clearCanvas(); // очищаем холст
      // очищаем от спрайтов, которые не нужно рисовать (например, у которых стоит isHidden === true)

      var clearedSprites = this.clearSrpites(sprites); // получаем готовые к отрисовке "обертки спрайта" (например координаты, с учетом камеры, нарезанная анимация и т.д.)

      var spriteWrappers;

      var _iterator = _createForOfIteratorHelper(clearedSprites),
          _step;
      ...
      var sortedSpriteWrappers = this.sortSritesForRender(spriteWrappers); // отрисовываем подготовленные спрайты

      var _iterator2 = _createForOfIteratorHelper(sortedSpriteWrappers),
          _step2;

      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _sprite = _step2.value;
          this.drawSrpiteWrapperOnCanvas(_sprite);
        }
      } catch (err) {
        _iterator2.e(err);
      } finally {
    ...
    */
    ...
    key: "renderStaticPicture",
    value: function renderStaticPicture(picture, x, y) {
      ...
      this.canvasContext.drawImage(picture, x, y, width ? width : picture.width, height ? height : picture.height);
    }
    /** Замостить фон некоторой картинкой (желательно безшовной) */

  }, {
    key: "backgroundRepeat",
    value: function backgroundRepeat(picture) {
      var backgroungWidth = picture.width * this._camera.scaleMap; // изменяем ширину картинки с поправкой на масштаб

      var backgrounHeight = picture.height * this._camera.scaleMap; // изменяем ширину картинки с поправкой на масштаб

      var numWidth = Math.ceil(this.canvasElement.width / backgroungWidth); // сколько картинок раскидать в ширь

      var numHeight = Math.ceil(this.canvasElement.height / backgrounHeight); // сколько картинок раскидать в высоту

      for (var i = -1; i <= numWidth; i++) {
        // замостим по ширине
        for (var ii = -1; ii <= numHeight; ii++) {
          // замостим по высоте
          var x = Math.ceil(this._camera.coordinates.x / backgroungWidth);
          var y = Math.ceil(this._camera.coordinates.y / backgrounHeight);
          this.canvasContext.drawImage(picture, -x * backgroungWidth + backgroungWidth * i + this._camera.coordinates.x, // x
    ...
    key: "sortSritesForRender",
    value: function sortSritesForRender(sprites) {
      sprites.sort(function (a, b) {
        // используем встроенную в массивы ф-ию сортировки https://habr.com/ru/post/279867/
        if (a.layer == b.layer) {
          // если у спрайтов одинаковые слои
          // сортировка по возростанию координаты
          return a.coordinates.y + a.height - (b.coordinates.y + b.height);
        } else {
          // если у спрайтов разные слои
    ...
    key: "clearSrpites",
    value: function clearSrpites(sprites) {
      return sprites.filter(function (sprite) {
        return sprite.isHidden !== true;
      });
    }
    ...
    key: "getSpriteWrapper",
    value: function getSpriteWrapper(sprite) {
      var result;

      if (sprite.animation) {
        // если это анимация, то создается одна спрайт-обертка под анимацию
        result = new SpriteAnimationWrapper();
      } else {
        // иначе созадется простая спрайт-обертка
      ...
      result.coordinates = new _common__WEBPACK_IMPORTED_MODULE_1__["X_Y"](sprite.coordinates.x, sprite.coordinates.y); // Начинается логика
      // если это анимация

      if (result instanceof SpriteAnimationWrapper) {
        // высчитываем левую верхнюю координату нарезного кадра в общей картинке
        result.leftUpCoordinatesSlicedOneFrame = new _common__WEBPACK_IMPORTED_MODULE_1__["X_Y"]( // x = ширина нарезного кадра * номер кадра
        sprite.animation.widthSlicedOneFrame * sprite.animation.frameNumNext, // y = 0 т.к. у на не поддерживаются многоэтажные общие картинки анимации
        0);
        result.widthSlicedOneFrame = sprite.animation.widthSlicedOneFrame;
        result.heightSlicedOneFrame = sprite.image.height; // высота нарезного 
      ...
      if (sprite.isStaticCoordinates !== true) {
        // на статические спрайты не распространяется
      ...
      result.coordinates.y = result.coordinates.y + sprite.offsetPic.y; // учитываем параметры камеры
    ...
    */
    ...
    key: "drawSrpiteWrapperOnCanvas",
    value: function drawSrpiteWrapperOnCanvas(sprite) {
      // сохраняем нормальные настройки канваса манипуляциями (например, кручением)
      this.canvasContext.save(); // делаем центр холста у этой картинки

      this.canvasContext.translate(sprite.coordinates.x, sprite.coordinates.y);
      this.canvasContext.translate(sprite.width / 2, sprite.height / 2); // крутим канвас если у картинку указано, что ее нужно крутануть 
      ...
      if (sprite instanceof SpriteAnimationWrapper) {
        // если анимация
        var spriteAnimantion = sprite;
        this.canvasContext.drawImage(spriteAnimantion.picture, spriteAnimantion.leftUpCoordinatesSlicedOneFrame.x, // x - координата левого верхнего угла вырезаемого кадра в общей картинке
        ...
        // если не анимация
        this.canvasContext.drawImage(sprite.picture, -(sprite.width / 2), -(sprite.height / 2), // вместо x,y здесь так, потому что ранее мы изменили центр canvas-а
...
var SpriteWrapper = /*#__PURE__*/function () {
  function SpriteWrapper() {
    _classCallCheck(this, SpriteWrapper);
  }

  _createClass(SpriteWrapper, [{
    key: "spriteId",
    // Публичные поля
    ...
    // Setter-ы свойств
    set: function set(spriteId) {
      this._spriteId = guid_typescript__WEBPACK_IMPORTED_MODULE_0__["Guid"].parse(spriteId.toString());
    }
  }]);
...
var SpriteAnimationWrapper = /*#__PURE__*/function (_SpriteWrapper) {
  _inherits(SpriteAnimationWrapper, _SpriteWrapper);

  var _super = _createSuper(SpriteAnimationWrapper);

  function SpriteAnimationWrapper() {
    _classCallCheck(this, SpriteAnimationWrapper);

    return _super.apply(this, arguments);
  }

  return SpriteAnimationWrapper;
}(SpriteWrapper);
/** градусы в радианы */
...
throw new Error("Module build failed (from ./node_modules/babel-loader/lib/index.js):\nSyntaxError: C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\src\\engine\\spriteHolder.ts: `import =` is not supported by @babel/plugin-transform-typescript\nPlease consider using `import <moduleName> from '<moduleName>';` alongside Typescript's --allowSyntheticDefaultImports option.\n\u001b[0m \u001b[90m 1 | \u001b[39m\u001b[36mimport\u001b[39m { \u001b[33mSprite\u001b[39m\u001b[33m,\u001b[39m \u001b[33mMaskFigure\u001b[39m } from \u001b[32m\"./sprite\"\u001b[39m\u001b[33m;\u001b[39m\u001b[0m\n\u001b[0m\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 2 | \u001b[39m\u001b[36mimport\u001b[39m \u001b[33mCollections\u001b[39m \u001b[33m=\u001b[39m require(\u001b[32m'typescript-collections'\u001b[39m)\u001b[33m;\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m   | \u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[31m\u001b[1m^\u001b[22m\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m 3 | \u001b[39m\u001b[36mimport\u001b[39m {sleep\u001b[33m,\u001b[39m \u001b[33mX_Y\u001b[39m} from \u001b[32m\"./common\"\u001b[39m\u001b[33m;\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m 4 | \u001b[39m\u001b[36mimport\u001b[39m { \u001b[33mGuid\u001b[39m } from \u001b[32m\"guid-typescript\"\u001b[39m\u001b[33m;\u001b[39m\u001b[0m\n\u001b[0m \u001b[90m 5 | \u001b[39m\u001b[36mimport\u001b[39m \u001b[33m*\u001b[39m as geometry from \u001b[32m\"./geometry\"\u001b[39m\u001b[33m;\u001b[39m\u001b[0m\n    at File.buildCodeFrameError (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\core\\lib\\transformation\\file\\file.js:248:12)\n    at NodePath.buildCodeFrameError (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\path\\index.js:144:21)\n    at PluginPass.TSImportEqualsDeclaration (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\plugin-transform-typescript\\lib\\index.js:331:20)\n    at newFn (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\visitors.js:179:21)\n    at NodePath._call (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\path\\context.js:55:20)\n    at NodePath.call (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\path\\context.js:42:17)\n    at NodePath.visit (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\path\\context.js:90:31)\n    at TraversalContext.visitQueue (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\context.js:112:16)\n    at TraversalContext.visitMultiple (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\context.js:79:17)\n    at TraversalContext.visit (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\context.js:138:19)\n    at Function.traverse.node (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\index.js:84:17)\n    at NodePath.visit (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\path\\context.js:97:18)\n    at TraversalContext.visitQueue (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\context.js:112:16)\n    at TraversalContext.visitSingle (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\context.js:84:19)\n    at TraversalContext.visit (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\context.js:140:19)\n    at Function.traverse.node (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\index.js:84:17)\n    at traverse (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\traverse\\lib\\index.js:66:12)\n    at transformFile (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\core\\lib\\transformation\\index.js:107:29)\n    at transformFile.next (<anonymous>)\n    at run (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\core\\lib\\transformation\\index.js:35:12)\n    at run.next (<anonymous>)\n    at Function.transform (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\@babel\\core\\lib\\transform.js:27:41)\n    at transform.next (<anonymous>)\n    at step (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\gensync\\index.js:254:32)\n    at gen.next (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\gensync\\index.js:266:13)\n    at async.call.value (C:\\Users\\baban\\Desktop\\Code\\C#\\GenerallyFire\\Code\\MagicRoyale-TeleportAndFire\\MagicRoyale-TeleportAndFire.UI\\main\\node_modules\\gensync\\index.js:216:11)");
...
/* harmony import */ var _engine_engine__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./engine/engine */ "./src/engine/engine.ts");
...
function initialize() {
  var gameCanvasParrentElement = document.getElementById('gameContent');
  var engine = new _engine_engine__WEBPACK_IMPORTED_MODULE_2__["Engine"](gameCanvasParrentElement);
  createSprites(engine);
}

function createSprites(engine) {}
...
/******/ });
//# sourceMappingURL=main.00f81cc54069396918c4.js.map